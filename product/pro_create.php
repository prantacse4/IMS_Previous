              ...
              <form class="form-horizontal" action="cat_create.php" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="p_name" class="form-control" id="inputEmail3" placeholder="Enter Product Name">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="description" class="form-control" id="inputPassword3" placeholder="Description about product">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="product_code" class="form-control" id="inputPassword3" placeholder="Product code">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="quantity_type" class="form-control" id="inputPassword3" placeholder="Quantity type">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="total_price" class="form-control" id="inputPassword3" placeholder="Total price">
                    </div>
                  </div>
